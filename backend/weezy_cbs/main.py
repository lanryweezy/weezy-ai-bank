...
from weezy_cbs.standing_instructions import api as si_api
...
app.include_router(si_api.router, prefix="/api/corebanking/recurring", tags=["Standing Instructions & ACH"])
...
app.include_router(cheque_leaf_api.router, prefix="/api/corebanking/cheques/leaves", tags=["Cheque Leaf & Stop-Payment Management"])
