    ...
    <Layout>
      <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            {/* AI Insights & Manual Action */}
            <div className="space-y-8">
                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Manual Escallation</h3>
                <Card className="border-none shadow-sm ring-1 ring-slate-200/60 rounded-[32px] bg-white p-8 space-y-4">
                    <Button variant="outline" className="w-full justify-start h-12 rounded-xl text-[10px] font-black uppercase tracking-widest gap-4 border-slate-100 hover:bg-indigo-50 hover:border-indigo-100 transition-all">
                        <MessageSquare className="h-4 w-4 text-blue-500" /> Send WhatsApp warning
                    </Button>
                    <Button variant="outline" className="w-full justify-start h-12 rounded-xl text-[10px] font-black uppercase tracking-widest gap-4 border-slate-100 hover:bg-emerald-50 hover:border-emerald-100 transition-all">
                        <PhoneCall className="h-4 w-4 text-emerald-500" /> Log physical visit
                    </Button>
                    <Button variant="outline" className="w-full justify-start h-12 rounded-xl text-[10px] font-black uppercase tracking-widest gap-4 border-slate-100 hover:bg-amber-50 hover:border-amber-100 transition-all">
                        <Calendar className="h-4 w-4 text-amber-500" /> Promise to pay
                    </Button>
                </Card>
                ...
                <Card className="bg-slate-950 text-white border-none shadow-2xl rounded-[40px] overflow-hidden relative group">
                    ...
                    <div className="p-10 relative z-10 space-y-6">
                        ...
                        <CardTitle className="text-2xl font-black italic tracking-tighter uppercase leading-tight">Global Standing Instruction</CardTitle>
                ...
                <div className="p-8 bg-rose-50 border border-rose-100 rounded-[40px] relative overflow-hidden group">
                    <TrendingDown className="absolute bottom-[-10px] right-[-10px] h-24 w-24 text-rose-200/30 -rotate-12 group-hover:rotate-0 transition-transform duration-700" />
                    <h4 className="text-[10px] font-black text-rose-700 uppercase tracking-widest mb-4 flex items-center gap-2">
                        <Activity className="h-3 w-3" /> Autonomous Outreach
                    </h4>
                    <p className="text-xs text-rose-700 italic leading-relaxed font-black tracking-tight relative z-10">
